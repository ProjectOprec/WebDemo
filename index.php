...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Web Testing - <?php require('get_title.php'); ?></title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>Web Testing</b></a>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p><?php echo "Automation Testing"//$_SESSION['nama']; ?></p>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Team Automation i3</a></strong>
      </footer>
    </div><!-- ./wrapper -->
